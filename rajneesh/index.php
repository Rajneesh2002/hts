...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<h1>THE <p style="color: #1641cb; display: inline;">DBMS</p> HOTEL</h1>
	<div class="icon">
		<ul>
		...
		<div class="mySlides fade">
			<img id="2" src="Images/2.jpg" style="width:100%; height:530px;">
			<div class="text">REDEFINE LUXURY</div>
		</div>

		<div class="mySlides fade">
		  <img id="1" src="Images/1.jpg" style="width:100%; height:530px;">
		  <div class="text">ENJOY THE DREAM EXPERIENCE</div>
		</div>

		<div class="mySlides fade">
		  <img id="3" src="Images/3.jpg" style="width:100%; height:530px;">
		...
		<div id="contact" class="footer">
			...
			<h3 class="foot-text">Developed by Rajneesh , Madhur , Amrit</h3>
			<h3 class="foot-text">Copyright @2022</h3><br>
		</div>
	</body>
</html>